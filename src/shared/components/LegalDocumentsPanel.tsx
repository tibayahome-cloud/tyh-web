    ...
    {CURRENT_LEGAL_DOCUMENTS.map((document) => {
      ...
      return (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white px-4 py-4 text-left shadow-sm transition hover:border-tiba-blue hover:shadow-md sm:flex-row sm:items-center sm:justify-between"
        >
