...
const fetchPendingFacilityPayoutDestinationChangeMock = vi.fn();
...
vi.mock("../../../../../shared/libs/wallet", () => ({
  ...
  fetchPendingFacilityPayoutDestinationChange: (...args: unknown[]) => fetchPendingFacilityPayoutDestinationChangeMock(...args),
