                ...
                <Card className="relative overflow-hidden border-none bg-indigo-50/50 p-6 shadow-sm ring-1 ring-indigo-100">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-slate-900">Unlock AI Insights</h3>
                                <p className="text-[11px] font-medium text-slate-500 uppercase tracking-wider">Health Wellness</p>
                            </div>
                        </div>
                        ...
                        <Button
                            variant="secondary"
                            className="w-full rounded-xl h-10 text-xs font-bold border-none bg-white shadow-sm hover:bg-slate-50 text-indigo-600"
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <h3 className="text-sm font-bold text-slate-900">AI Wellness Insight</h3>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Personalized Recommendation</p>
                            </div>
                        </div>
                        ...
                        {recommendation.steps.slice(0, 2).map((step, idx) => (
                            <div key={idx} className="flex items-start gap-3 rounded-2xl bg-slate-50 p-3 ring-1 ring-slate-100 transition-colors hover:bg-slate-100/80">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-[11px] font-medium text-slate-500 leading-normal">{step.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-xs font-bold">View Full Care Plan</p>
                        </div>
